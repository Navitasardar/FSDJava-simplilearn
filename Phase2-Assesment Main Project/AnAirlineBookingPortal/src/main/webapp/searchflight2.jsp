...
<body>
	...
	public void jspInit() {
		try {
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_world", "master", "root");
	...
	<sql:setDataSource var="db" driver="com.mysql.cj.jdbc.Driver"
		url="jdbc:mysql://localhost:3306/db_world" user="root" password="Parth@123" />
	...
	<table border="2" width="100%">
		...
		<c:forEach var="table" items="${rs.rows}">
			<tr>
				<td><a href="registerdetails.jsp"> <c:out
							value="${table.flightno}" /></a></td>
